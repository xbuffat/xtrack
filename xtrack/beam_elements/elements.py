...
class LinearTransferMatrixWithSigma(BeamElement):
    _xofields={
        'no_detuning': xo.Int64,
        'q_x': xo.Float64,
        'q_y': xo.Float64,
...
LinearTransferMatrixWithSigma.XoStruct.extra_sources = [
        _pkg_root.joinpath('beam_elements/elements_src/lineartransfermatrixwithsigma.h')]
